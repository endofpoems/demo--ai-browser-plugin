...
AI网页学习插件是一个Edge/Chrome浏览器插件，功能：页面总结、划词链式解释、思维导图、MD文件生成。
...
1. 页面总结：Alt+S，AI 四维度总结 + 可拖拽+Resize面板（自适应画面）
2. 划词链式解释：Alt+W，每次划词生成新消息框解释旧框内容，旧框不消失
3. 思维导图：箭头从总结面板左右划出，智能检测技术名词切换生成策略
4. MD下载：总结完成后下载 Markdown 文件

已开发

[√] 页面总结（拖拽+Resize） [√] 划词链式解释 [√] MD下载
[√] 设置页（测试连接） [√] 思维导图（面板侧滑+智能生成） [√] 全链路错误处理
